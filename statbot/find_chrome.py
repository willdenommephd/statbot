...
#For most cases, this will have very little impact. But if you have some security or permission issues, this will allow you to select a different Chrome that your Python terminal, or StatBot, can access. 
